...
namespace Teste.Simasoft.Challenges.SortFeliz.Numeros.Felizes
{
    [TestClass]
    public class NumerosFelizesTeste
    {
        [Description("Gera o Loop inicial")]
        [TestMethod]
        public void DesmembraNumero()
        {
            int numero = 7;
            //int resultado = 0;
            int totAlgarismo = 0;
        ...
        public int ProcessaSomaAlgarismos(int numero,int iteracao, out int totAlgarismo){
            int resultado = 0;
            if(iteracao == 1){
